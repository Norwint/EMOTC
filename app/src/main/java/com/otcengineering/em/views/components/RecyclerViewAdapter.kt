package com.otcengineering.em.views.components
...
import java.util.*
import com.otcengineering.em.BR
...
open class RecyclerViewAdapter<T>(
    ...
    var onBinding: ((ViewDataBinding, T) -> Unit)? = null
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder<ViewDataBinding>, position: Int) {
        ...
        onBinding?.let { it(viewHolder.binding, model) }
    }
...
fun <T> RecyclerView.addSource(
    ...
    return addSource(rowLayout, observableList, onClickListener, null)
}
