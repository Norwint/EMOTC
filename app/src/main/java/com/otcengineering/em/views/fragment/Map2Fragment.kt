...
class Map2Fragment : Fragment() {
    ...
    private val binding: FragmentMap2Binding by lazy {
        FragmentMap2Binding.inflate(
            layoutInflater
        )
    }
    ...
    override fun onCreateView(
        ...
        val throttle = (settings.vehicleSettings.mapsList[1].settingsList[0].value - settings.settingsRangeList[3].minValue) / (settings.settingsRangeList[3].maxValue - settings.settingsRangeList[3].minValue) * 100
        val power = (settings.vehicleSettings.mapsList[1].settingsList[4].value - settings.settingsRangeList[7].minValue) / (settings.settingsRangeList[7].maxValue - settings.settingsRangeList[7].minValue) * 100
        val rpm = (settings.vehicleSettings.mapsList[1].settingsList[3].value - settings.settingsRangeList[6].minValue) / (settings.settingsRangeList[6].maxValue - settings.settingsRangeList[6].minValue) * 100

        val throttleSpeed = (settings.vehicleSettings.mapsList[1].settingsList[1].value - settings.settingsRangeList[4].minValue) / (settings.settingsRangeList[4].maxValue - settings.settingsRangeList[4].minValue) * 100
        val throttleTorque = (settings.vehicleSettings.mapsList[1].settingsList[2].value - settings.settingsRangeList[5].minValue) / (settings.settingsRangeList[5].maxValue - settings.settingsRangeList[5].minValue) * 100
